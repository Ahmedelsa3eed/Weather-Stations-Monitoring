...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: humidity = (Integer)value$; break;
    case 1: temperature = (Integer)value$; break;
    case 2: windSpeed = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
    ...
    public Weather build() {
      try {
        ...
        record.humidity = fieldSetFlags()[0] ? this.humidity : (Integer) defaultValue(fields()[0]);
        record.temperature = fieldSetFlags()[1] ? this.temperature : (Integer) defaultValue(fields()[1]);
        record.windSpeed = fieldSetFlags()[2] ? this.windSpeed : (Integer) defaultValue(fields()[2]);
        return record;
