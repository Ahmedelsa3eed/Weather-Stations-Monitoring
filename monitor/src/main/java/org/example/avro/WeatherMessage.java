...
public class WeatherMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public WeatherMessage(Long stationId, Long serialNumber, CharSequence batteryStatus, Long statusTimestamp, Weather weather) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: stationId = (Long)value$; break;
    case 1: serialNumber = (Long)value$; break;
    case 2: batteryStatus = (CharSequence)value$; break;
    case 3: statusTimestamp = (Long)value$; break;
   ...
   * @return A new WeatherMessage RecordBuilder
   */
  public static Builder newBuilder(WeatherMessage other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WeatherMessage>
    ...
    public Builder setWeatherBuilder(Weather.Builder value) {
      clearWeather();
    ...
    public WeatherMessage build() {
      try {
        ...
        record.stationId = fieldSetFlags()[0] ? this.stationId : (Long) defaultValue(fields()[0]);
        record.serialNumber = fieldSetFlags()[1] ? this.serialNumber : (Long) defaultValue(fields()[1]);
        record.batteryStatus = fieldSetFlags()[2] ? this.batteryStatus : (CharSequence) defaultValue(fields()[2]);
        record.statusTimestamp = fieldSetFlags()[3] ? this.statusTimestamp : (Long) defaultValue(fields()[3]);
        if (weatherBuilder != null) {
          try {
